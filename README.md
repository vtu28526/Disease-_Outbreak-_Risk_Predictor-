...
A Flask web app that uses private county-level health indicators to estimate disease outbreak risk, with prediction, history, analysis, and project information pages.
...
- Home: project summary and coverage.
- Predict: choose disease category and county, then generate an explainable risk score.
- History: view saved predictions.
- Analysis: view model summaries and risk trends.
- About: scoring method and project notes.
